...
For more information about each installation option, refer to [this page.]({{<baseurl>}}/rancher/v2.0-v2.4/en/installation)
...
For an example of one way to set up the MySQL database, refer to this [tutorial]({{<baseurl>}}/rancher/v2.0-v2.4/en/installation/options/rds/) for setting up MySQL on Amazon's RDS service.
