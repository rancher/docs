...
>**Want full usage and options for the migration-tools CLI?** See the [Migration Tools CLI Reference](../../../reference-guides/v1.6-migration/migration-tools-cli-reference.md).
...
![Imported Services](/img/imported-workloads.png)
...
![Edit Migrated Workload](/img/edit-migration-workload.gif)
...
![output.txt](/img/output-dot-text.png)
