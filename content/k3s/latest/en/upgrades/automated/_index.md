...
>**Note:** The upgrade job that is launched must be highly privileged. It requires the following:
>
...
As stated, the upgrade will begin as soon as the controller detects that the plans were created. Updating a plan will cause the controller to re-evaluate the plan and determine if another upgrade is needed.
