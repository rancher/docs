...
* Make sure your nodes fulfill all of the node requirements, including the [port requirements.]({{<baseurl>}}/rancher/v2.x/en/cluster-provisioning/node-requirements/#port-requirements)
