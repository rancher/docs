...
- Enable [monitoring, alerts and notifiers]({{<baseurl>}}/rancher/v2.x/en/monitoring-alerting/v2.5/)
- Enable [logging]({{<baseurl>}}/rancher/v2.x/en/logging/v2.5/)
- Enable [Istio]({{<baseurl>}}/rancher/v2.x/en/istio/v2.5/)
...
- The ability to [upgrade the K3s version]({{<baseurl>}}/rancher/v2.x/en/cluster-admin/upgrading-kubernetes/)
...
The capabilities for registered EKS clusters are listed in the table on [this page.]({{<baseurl>}}/rancher/v2.x/en/cluster-provisioning/)
