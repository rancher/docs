...
1. Optional: Add additional resources or configuration via the [overlay file.]({{<baseurl>}}/rancher/v2.x/en/istio/v2.5/configuration-reference/#overlay-file)
1. Click **Install**.
...
For more information on configuring Istio, refer to the [configuration reference.]({{<baseurl>}}/rancher/v2.x/en/istio/v2.5/configuration-reference)
