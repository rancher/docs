...
1. [Set up nodes with taints and tolerations for the Istio components and Istio Gateway.]({{<baseurl>}}/rancher/v2.x/en/cluster-admin/tools/istio/setup/taints-and-tolerations)
