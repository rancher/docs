...
> **Note:** The Kubernetes API can change between minor versions. Therefore, we don't support upgrades of minor Kubernetes versions, such as upgrades from 1.14 to 1.15, without upgrading Rancher.
