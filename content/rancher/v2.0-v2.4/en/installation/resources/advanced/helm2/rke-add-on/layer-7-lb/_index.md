...
1. Download one of following templates, depending on the SSL certificate you're using.
    ...
    >
    >- Want records of all transactions with the Rancher API? Enable the [API Auditing]({{<baseurl>}}/rancher/v2.0-v2.4/en/installation/api-auditing) feature by editing your RKE config file. For more information, see how to enable it in [your RKE config file]({{<baseurl>}}/rancher/v2.0-v2.4/en/installation/options/helm2/rke-add-on/api-auditing/).
...
- **Recommended:** Review [Creating Backups—High Availability Back Up and Restore]({{<baseurl>}}/rancher/v2.0-v2.4/en/backups/backups/ha-backups/) to learn how to backup your Rancher Server in case of a disaster scenario.
