...
weight: 300
aliases:
  - /rancher/v2.0.x-v2.4.x/en/catalog/catalog-config
---
...
When [adding your catalog]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/catalog/custom/adding/) to Rancher, you'll provide the following information:
...
| Helm version | The Helm version that will be used to deploy all of the charts in the catalog. This field cannot be changed later. For more information, refer to the [section on Helm versions.]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/catalog/#catalog-helm-deployment-versions) |
...
1. When [adding the catalog]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/catalog/custom/adding/), select the **Use private catalog** checkbox.
...
2. When [adding the catalog]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/catalog/custom/adding/), select the **Use private catalog** checkbox.
