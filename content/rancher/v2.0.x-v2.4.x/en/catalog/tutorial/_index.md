...
3. **Recommended:** Create a `questions.yml` file.
    ...
    <br/>
    <br/>
    For a list of variables you can use when creating a `questions.yml` file, see [Question Variable Reference]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/catalog/creating-apps/#question-variable-reference).
