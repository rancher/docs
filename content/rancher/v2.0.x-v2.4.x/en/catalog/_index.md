...
weight: 4000
aliases:
  - /rancher/v2.0.x-v2.4.x/en/concepts/global-configuration/catalog/
  - /rancher/v2.0.x-v2.4.x/en/concepts/catalogs/
  - /rancher/v2.0.x-v2.4.x/en/tasks/global-configuration/catalog/
---
...
Within Rancher, there are default catalogs packaged as part of Rancher. These can be enabled or disabled by an administrator. For details, refer to the section on managing [built-in global catalogs.]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/catalog/built-in)

# Custom Catalogs

There are two types of catalogs in Rancher: [Built-in global catalogs]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/catalog/built-in/) and [custom catalogs.]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/catalog/adding-catalogs/)

Any user can create custom catalogs to add into Rancher.  Custom catalogs can be added into Rancher at the global level, cluster level, or project level. For details, refer to the [section on adding custom catalogs]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/catalog/adding-catalogs) and the [catalog configuration reference.]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/catalog/catalog-config)
...
* [Multi-cluster applications]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/catalog/multi-cluster-apps/)
* [Creating catalog apps]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/catalog/creating-apps)
* [Launching catalog apps within a project]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/catalog/launching-apps)
* [Managing catalog apps]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/catalog/managing-apps)
* [Tutorial: Example custom chart creation]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/catalog/tutorial)
...
For more information on how to use this feature, see [Global DNS]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/catalog/globaldns/).
