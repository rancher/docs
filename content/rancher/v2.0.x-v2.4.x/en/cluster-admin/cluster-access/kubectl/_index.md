...
weight: 2010
aliases:
  - /rancher/v2.0.x-v2.4.x/en/k8s-in-rancher/kubectl/
  - /rancher/v2.0.x-v2.4.x/en/cluster-admin/kubectl
  - /rancher/v2.0.x-v2.4.x/en/concepts/clusters/kubeconfig-files/
  - /rancher/v2.0.x-v2.4.x/en/k8s-in-rancher/kubeconfig/
