...
weight: 1
aliases:
 - /rancher/v2.0.x-v2.4.x/en/cluster-admin/tools/opa-gatekeeper
---
...
> - The dashboard needs to be enabled using the `dashboard` feature flag. For more information, refer to the [section on enabling experimental features.]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/options/feature-flags/)
