...
weight: 1116
aliases:
    - /rancher/v2.0.x-v2.4.x/en/tasks/global-configuration/authentication/github/
---

In environments using GitHub, you can configure Rancher to allow sign on using GitHub credentials.

>**Prerequisites:** Read [External Authentication Configuration and Principal Users]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/admin-settings/authentication/#external-authentication-configuration-and-principal-users).
