...
weight: 1114
aliases:
    - /rancher/v2.0.x-v2.4.x/en/tasks/global-configuration/authentication/freeipa/
---
...
>- Read [External Authentication Configuration and Principal Users]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/admin-settings/authentication/#external-authentication-configuration-and-principal-users).
