...
- [1 — Configuring Microsoft AD FS for Rancher]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/admin-settings/authentication/microsoft-adfs/microsoft-adfs-setup)
- [2 — Configuring Rancher for Microsoft AD FS]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/admin-settings/authentication/microsoft-adfs/rancher-adfs-setup)

{{< saml_caveats >}}


### [Next: Configuring Microsoft AD FS for Rancher]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/admin-settings/authentication/microsoft-adfs/microsoft-adfs-setup)
