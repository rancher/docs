...
When you create a [CIS benchmark compliant cluster,]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/security/) you have an encryption config file and an audit log config file.
