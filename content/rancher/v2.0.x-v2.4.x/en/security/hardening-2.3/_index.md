...
For more detail about evaluating a hardened cluster against the official CIS benchmark, refer to the [CIS Benchmark Rancher Self-Assessment Guide - Rancher v2.3.x]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/security/benchmark-2.3/).
...
Follow the steps as documented in [1.4.12]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/security/hardening-2.3/#1-4-12-ensure-that-the-etcd-data-directory-ownership-is-set-to-etcd-etcd) remediation.
...
- <https://rancher.com/docs/rancher/v2.0.x-v2.4.x/en/installation/options/chart-options/#advanced-options>
...
- <https://rancher.com/docs/rancher/v2.0.x-v2.4.x/en/admin-settings/authentication/>
