...
In the image below, the `web-deployment.yml` and `web-service.yml` files [created after parsing]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/v1.6-migration/run-migration-tool/#migration-example-file-output) our [migration example services]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/v1.6-migration/#migration-example-files) are linked together.
...
### [Next: Load Balancing]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/v1.6-migration/load-balancing/)
