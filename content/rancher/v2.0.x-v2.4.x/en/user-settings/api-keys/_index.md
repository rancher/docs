...
weight: 7005
aliases:
  - /rancher/v2.0.x-v2.4.x/en/concepts/api-keys/
  - /rancher/v2.0.x-v2.4.x/en/tasks/user-settings/api-keys/
---
...
- API keys are used for API calls and [Rancher CLI]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/cli).
