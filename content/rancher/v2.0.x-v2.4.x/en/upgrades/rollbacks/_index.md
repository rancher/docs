...
- [Rolling back Rancher installed with Docker]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/upgrades/rollbacks/single-node-rollbacks/)
- [Rolling back Rancher installed on a Kubernetes cluster]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/upgrades/rollbacks/ha-server-rollbacks/)
...
3. Rollback Rancher following the [normal instructions]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/upgrades/rollbacks/).
