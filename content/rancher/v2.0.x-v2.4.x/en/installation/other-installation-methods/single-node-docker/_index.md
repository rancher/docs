...
weight: 1
aliases:
  - /rancher/v2.0.x-v2.4.x/en/installation/single-node-install/
  - /rancher/v2.0.x-v2.4.x/en/installation/single-node
  - /rancher/v2.0.x-v2.4.x/en/installation/other-installation-methods/single-node
---
...
> See [Docker Install with an External Load Balancer]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/options/single-node-install-external-lb) instead.
...
Provision a single Linux host according to our [Requirements]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/requirements) to launch your Rancher server.
...
> **Do you want to...**
>
> - Use a proxy? See [HTTP Proxy Configuration]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/other-installation-methods/single-node-docker/proxy/)
> - Configure custom CA root certificate to access your services? See [Custom CA root certificate]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/other-installation-methods/single-node-docker/advanced/#custom-ca-certificate/)
> - Complete an Air Gap Installation? See [Air Gap: Docker Install]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/air-gap-single-node/)
