...
When installing Rancher, there are several [advanced options]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/options/) that can be enabled:
...
See [API Audit Log]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/api-auditing) for more information and options.
