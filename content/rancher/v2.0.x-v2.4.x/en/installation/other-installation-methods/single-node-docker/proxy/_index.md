...
weight: 251
aliases:
  - /rancher/v2.0.x-v2.4.x/en/installation/proxy-configuration/
  - /rancher/v2.0.x-v2.4.x/en/installation/single-node/proxy
---
...
Passing environment variables to the Rancher container can be done using `-e KEY=VALUE` or `--env KEY=VALUE`. Required values for `NO_PROXY` in a [Docker Installation]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/single-node-install/) are:
