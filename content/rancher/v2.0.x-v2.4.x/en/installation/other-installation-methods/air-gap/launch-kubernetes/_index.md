...
weight: 300
aliases:
  - /rancher/v2.0.x-v2.4.x/en/installation/air-gap-high-availability/install-kube
---
...
Replace values in the code sample below with help of the _RKE Options_ table. Use the IP address or DNS names of the [3 nodes]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/air-gap-high-availability/provision-hosts) you created.
