...
For systems without direct internet access, see [Helm - Air Gap]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/air-gap-installation/install-rancher/#helm) for install details.
...
See the [Troubleshooting]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/options/helm2/helm-init/troubleshooting/) page.

### [Next: Install Rancher]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/options/helm2/helm-rancher/)
