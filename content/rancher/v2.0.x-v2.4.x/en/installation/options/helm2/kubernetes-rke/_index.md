...
>**Note:** For systems without direct internet access see [Air Gap: Kubernetes install]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/air-gap-high-availability/) for install details.
...
See the [Troubleshooting]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/options/helm2/kubernetes-rke/troubleshooting/) page.

### [Next: Initialize Helm (Install tiller)]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/options/helm2/helm-init/)
