...
weight: 276
aliases:
- /rancher/v2.0.x-v2.4.x/en/installation/ha-server-install-external-lb/
---
...
1. Download one of following templates, depending on the SSL certificate you're using.
	...
	- [Template for self-signed certificate<br/> `3-node-externalssl-certificate.yml`]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/options/cluster-yml-templates/3-node-externalssl-certificate)
	- [Template for certificate signed by recognized CA<br/> `3-node-externalssl-recognizedca.yml`]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/options/cluster-yml-templates/3-node-externalssl-recognizedca)
...
- **Recommended:** Review [Creating Backups—High Availability Back Up and Restoration]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/backups/backups/ha-backups/) to learn how to backup your Rancher Server in case of a disaster scenario.
- Create a Kubernetes cluster: [Creating a Cluster]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/tasks/clusters/creating-a-cluster/).
