...
weight: 270
aliases:
  - /rancher/v2.0.x-v2.4.x/en/installation/ha/create-nodes-lb/nginx
  - /rancher/v2.0.x-v2.4.x/en/installation/k8s-install/create-nodes-lb/nginx
---
...
2.  From `nginx.conf`, replace both occurrences (port 80 and port 443) of `<IP_NODE_1>`, `<IP_NODE_2>`, and `<IP_NODE_3>` with the IPs of your [nodes]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/k8s-install/create-nodes-lb/).
