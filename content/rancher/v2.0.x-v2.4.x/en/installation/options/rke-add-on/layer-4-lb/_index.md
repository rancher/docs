...
weight: 275
aliases:
- /rancher/v2.0.x-v2.4.x/en/installation/ha/rke-add-on/layer-4-lb
---
...
We will be using NGINX as our Layer 4 Load Balancer (TCP). NGINX will forward all connections to one of your Rancher nodes. If you want to use Amazon NLB, you can skip this step and use [Amazon NLB configuration]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/options/rke-add-on/layer-4-lb/nlb/)
