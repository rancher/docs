...
This section describes how to use `firewalld` to apply the [firewall port rules]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/references) for nodes in a high-availability Rancher server cluster.
