...
weight: 10000
aliases:
  - /rancher/v2.0.x-v2.4.x/en/admin-settings/api-auditing/
---
...
- [Docker Install]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/other-installation-methods/single-node-docker/#api-audit-log)

- [Kubernetes Install]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/options/chart-options/#api-audit-log)
...
You can enable Rancher's built in log collection and shipping for the cluster to ship the audit and other services logs to a supported collection endpoint. See [Rancher Tools - Logging]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/cluster-admin/tools/logging) for details.
