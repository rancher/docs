...
weight: 2
aliases:
  - /rancher/v2.0.x-v2.4.x/en/admin-settings/feature-flags/istio-virtual-service-ui
---
...
> **Prerequisite:** Turning on this feature does not enable Istio. A cluster administrator needs to [enable Istio for the cluster]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/cluster-admin/tools/istio/setup) in order to use the feature.

To enable or disable this feature, refer to the instructions on [the main page about enabling experimental features.]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/options/feature-flags/)
