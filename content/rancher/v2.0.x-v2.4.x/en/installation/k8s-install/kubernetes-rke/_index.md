...
For systems without direct internet access, refer to [Air Gap: Kubernetes install.]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/air-gap-high-availability/)
...
> 
> For tuning your etcd cluster for larger Rancher installations, see the [etcd settings guide]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/options/etcd/).
...
See the [Troubleshooting]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/options/troubleshooting/) page.
{{% /tab %}}
{{% /tabs %}}

### [Next: Install Rancher]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/k8s-install/helm-rancher/)
