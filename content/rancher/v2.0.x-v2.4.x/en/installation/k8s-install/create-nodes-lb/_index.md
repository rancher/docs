...
weight: 185
aliases:
  - /rancher/v2.0.x-v2.4.x/en/installation/ha/create-nodes-lb
---
...
For more information about each installation option, refer to [this page.]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation)
...
For an example of one way to set up the MySQL database, refer to this [tutorial]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/options/rds/) for setting up MySQL on Amazon's RDS service.
...
### [Next: Set up a Kubernetes Cluster]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/k8s-install/kubernetes-rke/)