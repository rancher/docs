...
weight: 3025
aliases:
  - /rancher/v2.0.x-v2.4.x/en/concepts/workloads/
  - /rancher/v2.0.x-v2.4.x/en/tasks/workloads/
---
...
- [Deploy Workloads]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/k8s-in-rancher/workloads/deploy-workloads/)
- [Upgrade Workloads]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/k8s-in-rancher/workloads/upgrade-workloads/)
- [Rollback Workloads]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/k8s-in-rancher/workloads/rollback-workloads/)
