...
weight: 501
aliases:
  - /rancher/v2.0.x-v2.4.x/en/tools/pipelines/reference/
---
...
In the [pipeline configuration reference]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/k8s-in-rancher/pipelines/config), we provide examples of how to configure each feature using the Rancher UI or using YAML configuration.
