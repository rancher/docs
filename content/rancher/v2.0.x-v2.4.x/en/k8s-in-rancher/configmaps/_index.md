...
weight: 3061
aliases:
  - /rancher/v2.0.x-v2.4.x/en/tasks/projects/add-configmaps
---
...
1. Click **Save**.
	...
	>**Note:** Don't use ConfigMaps to store sensitive data [use a secret]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/k8s-in-rancher/secrets/).
	>
...
For more information on adding ConfigMaps to a workload, see [Deploying Workloads]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/k8s-in-rancher/workloads/deploy-workloads/).
