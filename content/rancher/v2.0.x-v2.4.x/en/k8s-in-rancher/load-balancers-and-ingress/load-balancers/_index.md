...
weight: 3041
aliases:
  - /rancher/v2.0.x-v2.4.x/en/concepts/load-balancing/
---
...
- [Kubernetes installation with External Load Balancer (HTTPS/Layer 7)]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/ha-server-install-external-lb)
- [Kubernetes installation with External Load Balancer (TCP/Layer 4)]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/ha-server-install)
- [Docker Installation with External Load Balancer]({{<baseurl>}}/rancher/v2.0.x-v2.4.x/en/installation/single-node-install-external-lb)
