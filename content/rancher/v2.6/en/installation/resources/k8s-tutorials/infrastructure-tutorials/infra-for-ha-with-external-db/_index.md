...
For an example of one way to set up the MySQL database, refer to this [tutorial]({{<baseurl>}}/rancher/v2.6/en/installation/options/rds/) for setting up MySQL on Amazon's RDS service.
