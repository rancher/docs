...
This section describes how to use `firewalld` to apply the [firewall port rules]({{<baseurl>}}/rancher/v2.6/en/installation/references) for nodes in a high-availability Rancher server cluster.
