...
1. For using the YAML editor, we can click **Create > Create from YAML.** Enter the Restore YAML.
	...
	spec:
      ...
      For help configuring the Restore, refer to the [configuration reference]({{<baseurl>}}/rancher/v2.6/en/backups/v2.6/configuration/restore-config/) and to the [examples.]({{<baseurl>}}/rancher/v2.6/en/backups/v2.6/examples/)
