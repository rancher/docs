...
weight: 3
aliases:
  - /rancher/v2.6/en/backups/v2.6/configuration/storage-config
---
...
| -------------- | -------------- |
| Credential Secret | Choose the credentials for S3 from your secrets in Rancher. [Example]({{<baseurl>}}/rancher/v2.6/en/backups/v2.6/examples/#example-credential-secret-for-storing-backups-in-s3). |
