...
weight: 1
aliases:
  - /rancher/v2.6/en/backups/v2.6/back-up-rancher
---

In this section, you'll learn how to back up Rancher running on any Kubernetes cluster. To backup Rancher installed with Docker, refer the instructions for [single node backups]({{<baseurl>}}/rancher/v2.6/en/backups/v2.6/docker-installs/docker-backups)
