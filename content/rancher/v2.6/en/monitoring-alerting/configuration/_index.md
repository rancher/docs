...
weight: 3
aliases:
  - /rancher/v2.6/en/monitoring-alerting/v2.6/configuration
---
...
An example of where this might be used is with Istio. For more information, see [this section.](https://rancher.com/docs/rancher/v2.6/en/istio/v2.6/configuration-reference/selectors-and-scrape)
