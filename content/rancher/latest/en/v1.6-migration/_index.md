...
>**Want to more about Kubernetes before getting started?** Read our [Kubernetes Introduction]({{<baseurl>}}/rancher/latest/en/v1.6-migration/kub-intro).


- [1. Get Started]({{<baseurl>}}/rancher/latest/en/v1.6-migration/get-started)
...
- [2. Migrate Your Services]({{<baseurl>}}/rancher/latest/en/v1.6-migration/run-migration-tool/)
- [3. Expose Your Services]({{<baseurl>}}/rancher/latest/en/v1.6-migration/expose-services/)
- [4. Configure Health Checks]({{<baseurl>}}/rancher/latest/en/v1.6-migration/monitor-apps)
- [5. Schedule Your Services]({{<baseurl>}}/rancher/latest/en/v1.6-migration/schedule-workloads/)
- [6. Service Discovery]({{<baseurl>}}/rancher/latest/en/v1.6-migration/discover-services/)
- [7. Load Balancing]({{<baseurl>}}/rancher/latest/en/v1.6-migration/load-balancing/)
...
### [Next: Get Started]({{<baseurl>}}/rancher/latest/en/v1.6-migration/get-started)
