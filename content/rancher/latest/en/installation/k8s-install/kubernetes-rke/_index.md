...
weight: 190
aliases:
  - /rancher/latest/en/installation/ha/kubernetes-rke/
---
...
For systems without direct internet access, refer to [Air Gap: Kubernetes install.]({{<baseurl>}}/rancher/latest/en/installation/air-gap-high-availability/)
...
### [Next: Install Rancher]({{<baseurl>}}/rancher/latest/en/installation/k8s-install/helm-rancher/)
