...
weight: 1
aliases:
  - /rancher/latest/en/installation/single-node-install/
  - /rancher/latest/en/installation/single-node
  - /rancher/latest/en/installation/other-installation-methods/single-node
---
...
> See [Docker Install with an External Load Balancer]({{<baseurl>}}/rancher/latest/en/installation/options/single-node-install-external-lb) instead.
...
Provision a single Linux host according to our [Requirements]({{<baseurl>}}/rancher/latest/en/installation/requirements) to launch your Rancher server.
...
> **Do you want to...**
>
> - Use a proxy? See [HTTP Proxy Configuration]({{<baseurl>}}/rancher/latest/en/installation/other-installation-methods/single-node-docker/proxy/)
> - Configure custom CA root certificate to access your services? See [Custom CA root certificate]({{<baseurl>}}/rancher/latest/en/installation/other-installation-methods/single-node-docker/advanced/#custom-ca-certificate/)
> - Complete an Air Gap Installation? See [Air Gap: Docker Install]({{<baseurl>}}/rancher/latest/en/installation/air-gap-single-node/)
