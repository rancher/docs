...
When installing Rancher, there are several [advanced options]({{<baseurl>}}/rancher/latest/en/installation/options/) that can be enabled:
...
See [API Audit Log]({{<baseurl>}}/rancher/latest/en/installation/api-auditing) for more information and options.
