...
> For reinstalling Rancher with Helm, please check [Option B: Reinstalling Rancher Chart]({{<baseurl>}}/rancher/latest/en/upgrades/upgrades/ha/#c-upgrade-rancher) under the upgrade Rancher section. 
...
> These instructions have been updated for Helm 3. If you are still using Helm 2, refer to [these instructions.]({{<baseurl>}}/rancher/latest/en/installation/options/upgrading-cert-manager/helm-2-instructions)
...
1. Follow the guide to [Prepare your Private Registry]({{<baseurl>}}/rancher/latest/en/installation/air-gap-installation/prepare-private-reg/) with the images needed for the upgrade.
