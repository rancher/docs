...
weight: 2
aliases:
  - /rancher/latest/en/admin-settings/feature-flags/istio-virtual-service-ui
---
...
> **Prerequisite:** Turning on this feature does not enable Istio. A cluster administrator needs to [enable Istio for the cluster]({{<baseurl>}}/rancher/latest/en/cluster-admin/tools/istio/setup) in order to use the feature.

To enable or disable this feature, refer to the instructions on [the main page about enabling experimental features.]({{<baseurl>}}/rancher/latest/en/installation/options/feature-flags/)
