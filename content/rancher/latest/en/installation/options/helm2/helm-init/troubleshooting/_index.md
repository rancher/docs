...
When you have confirmed that `tiller` has been removed, please follow the steps provided in [Initialize Helm (Install tiller)]({{<baseurl>}}/rancher/latest/en/installation/options/helm2/helm-init/) to install `tiller` with the correct `ServiceAccount`.
