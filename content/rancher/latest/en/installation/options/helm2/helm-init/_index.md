...
For systems without direct internet access, see [Helm - Air Gap]({{<baseurl>}}/rancher/latest/en/installation/air-gap-installation/install-rancher/#helm) for install details.
...
See the [Troubleshooting]({{<baseurl>}}/rancher/latest/en/installation/options/helm2/helm-init/troubleshooting/) page.

### [Next: Install Rancher]({{<baseurl>}}/rancher/latest/en/installation/options/helm2/helm-rancher/)
