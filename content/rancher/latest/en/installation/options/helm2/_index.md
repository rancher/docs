...
- [Create Nodes and Load Balancer]({{<baseurl>}}/rancher/latest/en/installation/options/helm2/create-nodes-lb/)
- [Install Kubernetes with RKE]({{<baseurl>}}/rancher/latest/en/installation/options/helm2/kubernetes-rke/)
- [Initialize Helm (tiller)]({{<baseurl>}}/rancher/latest/en/installation/options/helm2/helm-init/)
- [Install Rancher]({{<baseurl>}}/rancher/latest/en/installation/options/helm2/helm-rancher/)

## Additional Install Options

- [Migrating from a Kubernetes Install with an RKE Add-on]({{<baseurl>}}/rancher/latest/en/upgrades/upgrades/migrating-from-rke-add-on/)

## Previous Methods

[RKE add-on install]({{<baseurl>}}/rancher/latest/en/installation/options/helm2/rke-add-on/)
