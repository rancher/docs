...
weight: 5
aliases:
- /rancher/latest/en/installation/troubleshooting-ha/generic-troubleshooting/
---
...
Double check if all the [required ports]({{<baseurl>}}/rancher/latest/en/cluster-provisioning/node-requirements/#networking-requirements/) are opened in your (host) firewall.
