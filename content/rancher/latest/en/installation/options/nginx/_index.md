...
weight: 270
aliases:
  - /rancher/latest/en/installation/ha/create-nodes-lb/nginx
  - /rancher/latest/en/installation/k8s-install/create-nodes-lb/nginx
---
...
2.  From `nginx.conf`, replace both occurrences (port 80 and port 443) of `<IP_NODE_1>`, `<IP_NODE_2>`, and `<IP_NODE_3>` with the IPs of your [nodes]({{<baseurl>}}/rancher/latest/en/installation/k8s-install/create-nodes-lb/).
