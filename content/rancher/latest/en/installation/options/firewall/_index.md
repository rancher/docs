...
This section describes how to use `firewalld` to apply the [firewall port rules]({{<baseurl>}}/rancher/latest/en/installation/references) for nodes in a high-availability Rancher server cluster.
