...
weight: 277
aliases:
 - /rancher/latest/en/installation/ha/rke-add-on/proxy
---
...
* [Kubernetes Installation with External Load Balancer (TCP/Layer 4) RKE Config File Template]({{<baseurl>}}/rancher/latest/en/installation/ha-server-install/#5-download-rke-config-file-template)
* [Kubernetes Installation with External Load Balancer (HTTPS/Layer 7) RKE Config File Template]({{<baseurl>}}/rancher/latest/en/installation/ha-server-install-external-lb/#5-download-rke-config-file-template)
