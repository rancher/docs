...
weight: 277
aliases:
- /rancher/latest/en/installation/ha-server-install-external-lb/nginx/
- /rancher/latest/en/installation/ha/rke-add-on/layer-7-lb/nginx
---
...
See [Example NGINX config]({{<baseurl>}}/rancher/latest/en/installation/options/chart-options/#example-nginx-config).
