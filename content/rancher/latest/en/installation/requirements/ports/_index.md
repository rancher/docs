...
The port requirements differ depending on how the downstream cluster was launched. Each of the tabs below list the ports that need to be opened for different [cluster types]({{<baseurl>}}/rancher/latest/en/cluster-provisioning/#cluster-creation-options).
...
The following table depicts the port requirements for [hosted clusters]({{<baseurl>}}/rancher/latest/en/cluster-provisioning/hosted-kubernetes-clusters).
