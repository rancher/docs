...
weight: 4000
aliases:
  - /rancher/latest/en/concepts/global-configuration/catalog/
  - /rancher/latest/en/concepts/catalogs/
  - /rancher/latest/en/tasks/global-configuration/catalog/
---
...
Within Rancher, there are default catalogs packaged as part of Rancher. These can be enabled or disabled by an administrator. For details, refer to the section on managing [built-in global catalogs.]({{<baseurl>}}/rancher/latest/en/catalog/built-in)

# Custom Catalogs

There are two types of catalogs in Rancher: [Built-in global catalogs]({{<baseurl>}}/rancher/latest/en/catalog/built-in/) and [custom catalogs.]({{<baseurl>}}/rancher/latest/en/catalog/adding-catalogs/)

Any user can create custom catalogs to add into Rancher.  Custom catalogs can be added into Rancher at the global level, cluster level, or project level. For details, refer to the [section on adding custom catalogs]({{<baseurl>}}/rancher/latest/en/catalog/adding-catalogs) and the [catalog configuration reference.]({{<baseurl>}}/rancher/latest/en/catalog/catalog-config)
...
* [Multi-cluster applications]({{<baseurl>}}/rancher/latest/en/catalog/multi-cluster-apps/)
* [Creating catalog apps]({{<baseurl>}}/rancher/latest/en/catalog/creating-apps)
* [Launching catalog apps within a project]({{<baseurl>}}/rancher/latest/en/catalog/launching-apps)
* [Managing catalog apps]({{<baseurl>}}/rancher/latest/en/catalog/managing-apps)
* [Tutorial: Example custom chart creation]({{<baseurl>}}/rancher/latest/en/catalog/tutorial)
...
For more information on how to use this feature, see [Global DNS]({{<baseurl>}}/rancher/latest/en/catalog/globaldns/).
