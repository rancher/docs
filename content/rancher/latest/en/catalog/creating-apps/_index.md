...
weight: 400
aliases:
  - /rancher/latest/en/tasks/global-configuration/catalog/customizing-charts/
  - /rancher/latest/en/catalog/custom/creating
---
...
For a tutorial on adding a custom Helm chart to a custom catalog, refer to [this page.]({{<baseurl>}}/rancher/latest/en/catalog/tutorial)
