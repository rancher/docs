...
- [Rolling back Rancher installed with Docker]({{<baseurl>}}/rancher/latest/en/upgrades/rollbacks/single-node-rollbacks/)
- [Rolling back Rancher installed on a Kubernetes cluster]({{<baseurl>}}/rancher/latest/en/upgrades/rollbacks/ha-server-rollbacks/)
...
3. Rollback Rancher following the [normal instructions]({{<baseurl>}}/rancher/latest/en/upgrades/rollbacks/).
