...
weight: 1010
aliases:
  - /rancher/latest/en/upgrades/single-node-upgrade/
  - /rancher/latest/en/upgrades/upgrades/single-node-air-gap-upgrade
---
...
------------|-------------
`<RANCHER_VERSION_TAG>` | The release tag of the [Rancher version]({{<baseurl>}}/rancher/latest/en/installation/options/server-tags/) that you want to upgrade to.
...
If you used a proxy, see [HTTP Proxy Configuration.]({{<baseurl>}}/rancher/latest/en/installation/other-installation-methods/single-node-docker/proxy/)

If you configured a custom CA root certificate to access your services, see [Custom CA root certificate.]({{<baseurl>}}/rancher/latest/en/installation/other-installation-methods/single-node-docker/advanced/#custom-ca-certificate)

If you are recording all transactions with the Rancher API, see [API Auditing]({{<baseurl>}}/rancher/latest/en/installation/other-installation-methods/single-node-docker/advanced/#api-audit-log)
...
`<RANCHER_VERSION_TAG>` | The release tag of the [Rancher version]({{<baseurl>}}/rancher/latest/en/installation/options/server-tags/) that you want to to upgrade to.
...
If your upgrade does not complete successfully, you can roll back Rancher server and its data back to its last healthy state. For more information, see [Docker Rollback]({{<baseurl>}}/rancher/latest/en/upgrades/rollbacks/single-node-rollbacks/).
