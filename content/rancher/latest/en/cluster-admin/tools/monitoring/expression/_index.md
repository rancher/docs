...
The PromQL expressions in this doc can be used to configure [alerts.]({{<baseurl>}}/rancher/latest/en/cluster-admin/tools/alerts/)

> Before expression can be used in alerts, monitoring must be enabled. For more information, refer to the documentation on enabling monitoring [at the cluster level]({{<baseurl>}}/rancher/latest/en/cluster-admin/tools/monitoring/#enabling-cluster-monitoring) or [at the project level.]({{<baseurl>}}/rancher/latest/en/project-admin/tools/monitoring/#enabling-project-monitoring)
