...
While configuring monitoring at either the [cluster level]({{<baseurl>}}/rancher/latest/en/cluster-admin/tools/monitoring/#enabling-cluster-monitoring) or [project level]({{<baseurl>}}/rancher/latest/en/project-admin/tools/monitoring/#enabling-project-monitoring), there are multiple options that can be configured.
...
>**Prerequisite:** Configure one or more [storage class]({{<baseurl>}}/rancher/latest/en/cluster-admin/volumes-and-storage/#adding-storage-classes) to use as [persistent storage]({{<baseurl>}}/rancher/latest/en/cluster-admin/volumes-and-storage/) for your Prometheus or Grafana pod.
...
When enabling persistent storage for Prometheus or Grafana, specify the size of the persistent volume and select the [storage class]({{<baseurl>}}/rancher/latest/en/cluster-admin/volumes-and-storage/#storage-classes).
