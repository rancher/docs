...
> **Prerequisite:** Your cluster needs a worker node that can designated for Istio. The worker node should meet the [resource requirements.]({{<baseurl>}}/rancher/latest/en/cluster-admin/tools/istio/resources)
...
### [Next: Add Deployments and Services]({{<baseurl>}}/rancher/latest/en/cluster-admin/tools/istio/setup/deploy-workloads)