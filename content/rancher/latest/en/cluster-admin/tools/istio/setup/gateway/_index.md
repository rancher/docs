...
1. Under **Enable Ingress Gateway,** click **True.** The default type of service for the Istio gateway is NodePort. You can also configure it as a [load balancer.]({{<baseurl>}}/rancher/latest/en/k8s-in-rancher/load-balancers-and-ingress/load-balancers/)
...
### [Next: Set up Istio's Components for Traffic Management]({{<baseurl>}}/rancher/latest/en/cluster-admin/tools/istio/setup/set-up-traffic-management)
