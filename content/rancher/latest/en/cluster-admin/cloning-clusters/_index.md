...
weight: 2035
aliases:
  - /rancher/latest/en/cluster-provisioning/cloning-clusters/
---
...
|----------------------------------|---------------|
| [Nodes Hosted by Infrastructure Provider]({{<baseurl>}}/rancher/latest/en/cluster-provisioning/rke-clusters/node-pools/) | ✓ |
| [Hosted Kubernetes Providers]({{<baseurl>}}/rancher/latest/en/cluster-provisioning/hosted-kubernetes-clusters/) | ✓    |
| [Custom Cluster]({{<baseurl>}}/rancher/latest/en/cluster-provisioning/rke-clusters/custom-nodes)              | ✓              |
| [Imported Cluster]({{<baseurl>}}/rancher/latest/en/cluster-provisioning/imported-clusters/)            |               |
...
Download and install [Rancher CLI]({{<baseurl>}}/rancher/latest/en/cli). Remember to [create an API bearer token]({{<baseurl>}}/rancher/latest/en/user-settings/api-keys) if necessary.
...
> **Note:** As of Rancher v2.3.0, cluster configuration directives must be nested under the `rancher_kubernetes_engine_config` directive in `cluster.yml`. For more information, refer to the section on [the config file structure in Rancher v2.3.0+.]({{<baseurl>}}/rancher/latest/en/cluster-provisioning/rke-clusters/options/#config-file-structure-in-rancher-v2-3-0)
