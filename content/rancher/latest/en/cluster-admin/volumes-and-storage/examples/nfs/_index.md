...
weight: 3054
aliases:
  - /rancher/latest/en/tasks/clusters/adding-storage/provisioning-storage/nfs/
---
...
>**Note:**
>
>- If you already have an NFS share, you don't need to provision a new NFS server to use the NFS volume plugin within Rancher. Instead, skip the rest of this procedure and complete [adding storage]({{<baseurl>}}/rancher/latest/en/cluster-admin/volumes-and-storage/).
>
...
Within Rancher, add the NFS server as a [storage volume]({{<baseurl>}}/rancher/latest/en/k8s-in-rancher/volumes-and-storage/#adding-a-persistent-volume) and/or [storage class]({{<baseurl>}}/rancher/latest/en/k8s-in-rancher/volumes-and-storage/#adding-storage-classes). After adding the server, you can use it for storage for your deployments.
