...
- A bare-metal server
  ...
  >
  > For a full list of port requirements, refer to [Docker Installation]({{<baseurl>}}/rancher/latest/en/cluster-provisioning/node-requirements/).

  Provision the host according to our [Requirements]({{<baseurl>}}/rancher/latest/en/installation/requirements/).
