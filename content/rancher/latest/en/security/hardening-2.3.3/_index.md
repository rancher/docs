...
For more detail about evaluating a hardened cluster against the official CIS benchmark, refer to the [CIS Benchmark Rancher Self-Assessment Guide v2.3.3]({{<baseurl>}}/rancher/latest/en/security/benchmark-2.3.3/).
...
Follow the steps as documented in [1.4.12]({{<baseurl>}}/rancher/latest/en/security/hardening-2.3.3/#1-4-12-ensure-that-the-etcd-data-directory-ownership-is-set-to-etcd-etcd) remediation.
