...
For more detail on how a hardened cluster scores against the official CIS benchmark, refer to the [CIS Benchmark Rancher Self-Assessment Guide - Rancher v2.1.x]({{<baseurl>}}/rancher/latest/en/security/benchmark-2.1/).
