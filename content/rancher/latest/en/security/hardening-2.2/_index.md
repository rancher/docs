...
For more detail about evaluating a hardened cluster against the official CIS benchmark, refer to the [CIS Benchmark Rancher Self-Assessment Guide - Rancher v2.2.x]({{<baseurl>}}/rancher/latest/en/security/benchmark-2.2/).
