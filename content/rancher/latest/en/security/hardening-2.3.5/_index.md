...
For more detail about evaluating a hardened cluster against the official CIS benchmark, refer to the [CIS Benchmark Rancher Self-Assessment Guide - Rancher v2.3.5]({{< baseurl >}}/rancher/latest/en/security/benchmark-2.3.5/).
...
[documentaion](https://rancher.com/docs/rancher/latest/en/installation) for additional installation and RKE Template details.
