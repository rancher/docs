...
Within Rancher, only administrators or users with the **Manage Authentication** [global role]({{<baseurl>}}/rancher/latest/en/admin-settings/rbac/global-permissions/#global-permissions-reference) can configure authentication.
...
1. Sign into Rancher using a local user assigned the [administrator]({{<baseurl>}}/rancher/latest/en/admin-settings/rbac/global-permissions) role. This user is also called the local principal.
