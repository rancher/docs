...
weight: 1114
aliases:
    - /rancher/latest/en/tasks/global-configuration/authentication/freeipa/
---
...
>- Read [External Authentication Configuration and Principal Users]({{<baseurl>}}/rancher/latest/en/admin-settings/authentication/#external-authentication-configuration-and-principal-users).
