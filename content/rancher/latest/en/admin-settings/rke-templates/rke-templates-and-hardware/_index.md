...
When you create a [CIS benchmark compliant cluster,]({{<baseurl>}}/rancher/latest/en/security/) you have an encryption config file and an audit log config file.
