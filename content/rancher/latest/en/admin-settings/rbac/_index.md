...
weight: 1120
aliases:
    - /rancher/latest/en/concepts/global-configuration/users-permissions-roles/
---

Within Rancher, each person authenticates as a _user_, which is a login that grants you access to Rancher. As mentioned in [Authentication]({{<baseurl>}}/rancher/latest/en/admin-settings/authentication/), users can either be local or external.
...
- [Global Permissions]({{<baseurl>}}/rancher/latest/en/admin-settings/rbac/global-permissions/):

    Define user authorization outside the scope of any particular cluster.

- [Cluster and Project Roles]({{<baseurl>}}/rancher/latest/en/admin-settings/rbac/cluster-project-roles/):
