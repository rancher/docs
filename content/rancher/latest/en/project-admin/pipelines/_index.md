...
weight: 4000
aliases:
  - /rancher/latest/en/concepts/ci-cd-pipelines/
  - /rancher/latest/en/tasks/pipelines/
  - /rancher/latest/en/tools/pipelines/configurations/
---
...
For details, refer to the [pipelines]({{<baseurl>}}/rancher/latest/en/k8s-in-rancher/pipelines) section.