...
weight: 3025
aliases:
  - /rancher/latest/en/concepts/workloads/
  - /rancher/latest/en/tasks/workloads/
---
...
- [Deploy Workloads]({{<baseurl>}}/rancher/latest/en/k8s-in-rancher/workloads/deploy-workloads/)
- [Upgrade Workloads]({{<baseurl>}}/rancher/latest/en/k8s-in-rancher/workloads/upgrade-workloads/)
- [Rollback Workloads]({{<baseurl>}}/rancher/latest/en/k8s-in-rancher/workloads/rollback-workloads/)
