...
weight: 501
aliases:
  - /rancher/latest/en/tools/pipelines/reference/
---
...
In the [pipeline configuration reference]({{<baseurl>}}/rancher/latest/en/k8s-in-rancher/pipelines/config), we provide examples of how to configure each feature using the Rancher UI or using YAML configuration.
