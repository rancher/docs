...
weight: 3041
aliases:
  - /rancher/latest/en/concepts/load-balancing/
---
...
- [Kubernetes installation with External Load Balancer (HTTPS/Layer 7)]({{<baseurl>}}/rancher/latest/en/installation/ha-server-install-external-lb)
- [Kubernetes installation with External Load Balancer (TCP/Layer 4)]({{<baseurl>}}/rancher/latest/en/installation/ha-server-install)
- [Docker Installation with External Load Balancer]({{<baseurl>}}/rancher/latest/en/installation/single-node-install-external-lb)
