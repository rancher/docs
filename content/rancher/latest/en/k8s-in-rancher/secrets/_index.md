...
weight: 3062
aliases:
  - /rancher/latest/en/tasks/projects/add-a-secret
---
...
> This page is about secrets in general. For details on setting up a private registry, refer to the section on [registries.]({{<baseurl>}}/rancher/latest/en/k8s-in-rancher/registries)
...
4. Select a **Scope** for the secret. You can either make the registry available for the entire project or a single [namespace]({{<baseurl>}}/rancher/latest/en/k8s-in-rancher/projects-and-namespaces/#namespaces).
...
For more information on adding secret to a workload, see [Deploying Workloads]({{<baseurl>}}/rancher/latest/en/k8s-in-rancher/workloads/deploy-workloads/).
