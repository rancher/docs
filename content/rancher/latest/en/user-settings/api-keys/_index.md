...
weight: 7005
aliases:
  - /rancher/latest/en/concepts/api-keys/
  - /rancher/latest/en/tasks/user-settings/api-keys/
---
...
- API keys are used for API calls and [Rancher CLI]({{<baseurl>}}/rancher/latest/en/cli).
