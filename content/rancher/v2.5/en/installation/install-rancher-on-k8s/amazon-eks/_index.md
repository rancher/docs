...
> - Full administrative access is required to install the EKS cluster. The  `AdministratorAccess` IAM policy can be used.
...
```
2021-03-14 21:23:30 [ℹ]  eksctl version 0.40.0
2021-03-14 21:23:30 [ℹ]  using region us-west-2
NAMEREGIONEKSCTL CREATED
rancher-server-clusterus-west-2True
```
