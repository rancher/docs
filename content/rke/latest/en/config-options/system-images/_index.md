...
For RKE v0.2.x and below, the default versions of Kubernetes are tied to specific versions of the system images. Therefore, your Kubernetes version should match the version defined in the `rancher/types` defaults map, located here:

https://github.com/rancher/types/blob/release/v2.2/apis/management.cattle.io/v3/k8s_defaults.go

For RKE v0.3.0 and above, you can configure the Kubernetes version independently of the Rancher version. If you change the Kubernetes version, you can supply the corresponding system images yourself, according to the mappings in this file:
